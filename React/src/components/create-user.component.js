    ...
    onSubmit(e) {
        ...
        if(this.emailHandle(this.state.user_email.toLowerCase())){
            ...
            if(newUser.role === "role"){
                ...
                axios.post('http://'+process.env.REACT_APP_AWS_IP+':https/admin/addUser', newUser)
                .then( (response) => {console.log(response);
                                    if(response.status === 205){
                                        ...
                                        console.log("else");
                                        axios.post('http://'+process.env.REACT_APP_AWS_IP+':https/admin/send-email-staff', {email: this.state.user_email})
