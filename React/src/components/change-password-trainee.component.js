...
export default class ChangePassword extends Component {
    ...
    async componentDidMount() {
        await axios.get('http://'+process.env.REACT_APP_AWS_IP+':https/trainee/reset/'+this.props.match.params.token)
            .then(response => {
        ...
        axios.get('http://'+process.env.REACT_APP_AWS_IP+':https/trainee/'+this.state.trainee_id)
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
		...
		if (trainee_password !== confirmPassword){
            ...
            console.log(obj);
            axios.post('http://'+process.env.REACT_APP_AWS_IP+':https/trainee/update-password/'+this.props.match.params.token, obj)
            .then(res => {axios.get('http://'+process.env.REACT_APP_AWS_IP+':https/trainee/removeToken/'+this.props.match.params.token);
