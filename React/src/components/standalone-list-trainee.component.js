                                    ...
                                    <tr className="trainees">
                                        ...
                                        <td onClick={() => window.location.href = "/editDates/" + t._id}> <center>{t.bursary_amount * t.trainee_days_worked}</center></td>
                                            ...
                                            <center><button className="actionBtn" onClick={() => { 
                                                                ...
                                                                axios.get('https://'+process.env.REACT_APP_BACKEND_IP+'/trainee/'+deleteRoute+'/'+t._id).then(() => window.location.reload()) } }>
                                                                {deleteToggle}
                                                                <img src={close}></img>
                                                </button>&nbsp;
                                                ...
                                                <button className="actionBtn" onClick={() => { 
                                                                axios.post('https://'+process.env.REACT_APP_BACKEND_IP+'/trainee/send-email/', {trainee_email: t.trainee_email}).then(() => window.alert("Email Sent!")) } }>
