...
export default class EditTrainee extends Component {
    ...
    onChangeTraineeSort(e) {
        ...
        if(e.target.value.length > 5){
            ...
            axios.post('https://'+process.env.REACT_APP_AWS_IP+':4000/trainee/findBank', {sort_code: sortcode})
            .then(res => {
    ...
    onSubmit(e) {
        ...
        if(this.state.trainee_bursary==="True"){
            ...
            if(this.state.show_non_matching_bank == true){
                axios.post('https://'+process.env.REACT_APP_AWS_IP+':4000/trainee/update/'+this.props.match.params.id, updated_trainee)
                .then(res => {
                    console.log(res.data);
                    console.log(new_bank);
                    axios.post('https://'+process.env.REACT_APP_AWS_IP+':4000/trainee/addBank/', new_bank)
                    .then(res => {
                        console.log(res.data);
